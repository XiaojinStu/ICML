...
def angular_entropy_stable(logits: torch.Tensor,
    ...
    # Compute expected angular distance (ANE) (Paper Eq. 3)
...
class ANELoss(torch.nn.Module):
    """
    Neural Angular Entropy Loss Module.

    Wraps the ANE computation as a PyTorch module for cleaner integration.
    """
    ...
    def forward(self,
        ...
        if self.supervised:
            if target_idx is None:
                raise ValueError("target_idx required for supervised ANE")
