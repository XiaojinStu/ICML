...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--data_path", default="..//data/gsm8k")
...
def main():
    ...
    if os.path.isdir(args.data_path):
        # expect structure like <data_path>/main/train-00000-of-00001.parquet
        split = args.data_split
        parquet_path = os.path.join(args.data_path, "main", f"{split}-00000-of-00001.parquet")
        data = []
